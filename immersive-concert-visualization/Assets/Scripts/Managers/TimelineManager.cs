...
{
    private List<TimelineEvent> timelineEvents = new List<TimelineEvent>();  // store list of events
    ...
    private void Update()
    {
        ...
        {
            if (timelineEvents[i].timestamp <= currentTime && !timelineEvents[i].hasExecuted)
            {
